...
<?php get_template_part('template-parts/components/page', 'hero', [
	...
	'text'  => __('Auguste vient à vous. Commandez chez nous pour une livraison directe, ou passez par Uber Eats / Deliveroo.', 'comptoir-auguste'),
]); ?>
...
<div class="container section <?php echo esc_attr(ca_class('page-livraison', 'page')); ?>">
	...
	<aside class="<?php echo esc_attr(ca_class('page-livraison', 'info')); ?>">
		...
		<ul>
			<li><strong><?php esc_html_e('Modes', 'comptoir-auguste'); ?></strong><span><?php esc_html_e('Livraison directe, Uber Eats ou Deliveroo', 'comptoir-auguste'); ?></span></li>
		...
		<p class="<?php echo esc_attr(ca_class('page-livraison', 'note')); ?>">
			<?php esc_html_e('Commandez chez nous pour une livraison directe, ou via Uber Eats / Deliveroo — selon votre préférence.', 'comptoir-auguste'); ?>
		</p>
